...
- Width of data bus is what they mean when they say "this is a 32 CPU" or "this is a 64bit CPU". That's a maximum size (in bits) of data that CPU can receive or transmit at a given moment.
