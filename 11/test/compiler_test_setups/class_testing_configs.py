...
TEST__COMPILE_CLASS_VAR_DEC = {
    ...
    """field int a,b,c;""": {
        'class': {
            'a': {'type': 'int', 'kind': 'field', 'i': 0},
            'b': {'type': 'int', 'kind': 'field', 'i': 1},
            'c': {'type': 'int', 'kind': 'field', 'i': 2}
        }
    },
    """field int a; field Array arr; field String s;""": {
        'class': {
            'a'  : {'type': 'int'   , 'kind': 'field', 'i': 0},
            'arr': {'type': 'Array' , 'kind': 'field', 'i': 1},
            's'  : {'type': 'String', 'kind': 'field', 'i': 2}
        }
    },
    """field int a; static Double x,y,z; field String s1, s2; static Array arr1, arr2;""": {
        'class': {
            ...
            's1'  : {'type': 'String', 'kind': 'field' , 'i': 1},
            's2'  : {'type': 'String', 'kind': 'field' , 'i': 2},
